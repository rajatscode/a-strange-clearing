...
export default function BioPage({ onBack }: { onBack: () => void }) {
  return (
    <>
      <InnerPageCanvas />
      <div className="relative z-10 min-h-screen text-gray-400 flex items-center justify-center px-6">
        <BackGlyph onClick={onBack} />

        <div className="max-w-md">
          <p className="text-gray-300/70 text-base leading-[1.9] font-light">
            Rajat.
          </p>
          <p className="text-gray-400/60 text-sm leading-[1.9] mt-4">
            I build software and small systems.
          </p>
          <p className="text-gray-500/50 text-sm leading-[1.9] mt-2">
